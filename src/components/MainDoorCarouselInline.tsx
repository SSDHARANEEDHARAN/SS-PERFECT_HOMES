...
const mainDoors = [
  ...
  { src: mainDoor13, name: "Classic Pine Panel Door", specs: { material: "Pine Wood", size: "7x3 ft", finish: "Traditional Stain", hardware: "Bronze Handles" } },
  { src: mainDoor14, name: "Modern Teak Design", specs: { material: "Teak Wood", size: "7.5x3 ft", finish: "Contemporary Finish", hardware: "Steel Fittings" } },
  { src: mainDoor15, name: "Royal Oak Entrance", specs: { material: "Oak Wood", size: "8x3.5 ft", finish: "Royal Polish", hardware: "Gold Hardware" } },
  { src: mainDoor16, name: "Elegant Carved Door", specs: { material: "Sheesham Wood", size: "7x3 ft", finish: "Hand Carved", hardware: "Antique Brass" } },
  { src: mainDoor17, name: "Premium Walnut Panel", specs: { material: "Walnut Wood", size: "7.5x3.5 ft", finish: "Premium Finish", hardware: "Chrome Fittings" } },
  { src: mainDoor18, name: "Designer Glass Insert", specs: { material: "Teak Frame", size: "8x3.5 ft", finish: "Frosted Glass", hardware: "Modern Handles" } },
  { src: mainDoor19, name: "Traditional Solid Door", specs: { material: "Mango Wood", size: "7x3 ft", finish: "Natural Polish", hardware: "Traditional Brass" } },
  { src: mainDoor20, name: "Contemporary Style Door", specs: { material: "Engineered Wood", size: "7.5x3 ft", finish: "Modern Lacquer", hardware: "Stainless Steel" } },
];

export default function MainDoorCarouselInline() {
        ...
        <div className="relative overflow-hidden rounded-xl bg-card border shadow-lg">
          ...
          >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute left-4 z-10 bg-background/80 backdrop-blur-sm hover:bg-background/90 shadow-lg"
              onClick={prevSlide}
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-4 z-10 bg-background/80 backdrop-blur-sm hover:bg-background/90 shadow-lg"
              onClick={nextSlide}
            >
            ...
            {/* Dots indicator */}
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 flex-wrap justify-center max-w-md">
          ...
          <div className="p-6 bg-card">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-foreground mb-4 text-center">{currentDoor.name}</h2>
